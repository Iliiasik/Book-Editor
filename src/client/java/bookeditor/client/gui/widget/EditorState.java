...
public class EditorState {
    ...
    private final RichTextEditorWidget widget;
    public EditorState(TextRenderer textRenderer, boolean editable, Consumer<String> onImageUrlSeen, Runnable onDirty, RichTextEditorWidget widget) {
    ...
    public RichTextEditorWidget getWidget() {
        return widget;
    }
}